...
class AlarmReceiver : BroadcastReceiver() {
    ...
    fun setOneTimeAlarm(context: Context, type: String, date: String, time: String, message: String) {
        ...
        alarmManager.set(AlarmManager.RTC_WAKEUP, calendar.timeInMillis, pendingIntent) // <- set one time
    ...
    fun setRepeatingAlarm(context: Context, type: String, time: String, message: String) {
        ...
        alarmManager.setInexactRepeating(AlarmManager.RTC_WAKEUP, calendar.timeInMillis, AlarmManager.INTERVAL_DAY, pendingIntent)  // <- set repeating alarm
