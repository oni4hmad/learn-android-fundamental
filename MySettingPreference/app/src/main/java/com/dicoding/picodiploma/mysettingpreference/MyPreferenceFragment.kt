...
class MyPreferenceFragment : PreferenceFragmentCompat(),
    ...
    kita wajib register dan unregister listener nya di onResume () dan onPause () spy tdk memory leak
     */
    ...
    override fun onSharedPreferenceChanged(sharedPreferences: SharedPreferences, key: String) {
        ...
        /* untuk mengecek apakah terjadi perubahan pada data yang tersimpan */
