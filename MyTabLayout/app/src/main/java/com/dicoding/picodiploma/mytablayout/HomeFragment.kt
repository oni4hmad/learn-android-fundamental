...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val index = arguments?.getInt(ARG_SECTION_NUMBER, 0) /* ambil data */

        val index2 = arguments?.getInt(ARG_SECTION_NUMBER, 0)
        val name2 = arguments?.getString(ARG_NAME) /* ambil data 2 -- blm digunakan di view */
